...
local url,res = http.request('https://tomeiq.000webhostapp.com/chapi.php?id='..msg.sender_user_id_)
...
download_to_file('https://raw.githubusercontent.com/hussein2Me/Tshake/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/hussein2Me/Tshake/master/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/hussein2Me/files_tshake/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/hussein2Me/files_tshake/master/files_tshake/"..file)
if res == 200 then
